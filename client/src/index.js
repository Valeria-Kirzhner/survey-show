...
const store = createStore( reducers , {}, applyMiddleware(reduxThunk)); // the 1 argument is all the reducers, the 2 argument is the starting/initial state of the app - this more for server side rendering which is not in my case,  
